...
`tools/port-aasdk.sh`, and the submodule is never committed dirty. If you change the
port, regenerate the patch and re-run `tools/build-aasdk.sh`. Full write up in
